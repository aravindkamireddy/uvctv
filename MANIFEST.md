...
# MANIFEST.md - Vault Manifest (106 files - fix-batch A-F applied 2026-07-26, UNAUDITED)
...
│
├── package.json                                  P0  L7  SAT  all          (npm manifest: enables `npx github:YOUR-USERNAME/uvctv`; zero dependencies)
├── cli/bin/uvctv.js                              P0  L7  SAT  all          (the CLI: init/update/link/unlink/status/mcp; one implementation, all platforms)
...
**Total: 104 tree entries + 2 auxiliary artifacts = 106 files on disk.**
